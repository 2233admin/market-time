...
**Feature**: `venue-session-state` | **Constitution**: v1.2.0 | **Spec**: [proposal.md](../../openspec/changes/venue-session-state/proposal.md) | **Research**: [research.md](./research.md) | **Plan**: [design.md](../../openspec/changes/venue-session-state/design.md)
...
names (`market-time-cli`, `market-time-core`) come from `design.md`'s Project Structure; the
