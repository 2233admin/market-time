...
- [x] Principle IV (Library-First Core, Thin Shells) — not constrained at spec level; deferred to design (openspec/changes/venue-session-state/design.md)
...
**Status: all checklist items pass. Ready for design.**
