...
**Inputs**: [proposal.md](../../openspec/changes/venue-session-state/proposal.md) (FR-001..FR-020, Key Entities), [research.md](./research.md)
(D1..D7), [design.md](../../openspec/changes/venue-session-state/design.md) (crate layout), Constitution v1.2.0 (Principles I-V)
...
matters it is noted (`design.md`'s `crates/market-time-core/src/*.rs`), but the model itself is
language-neutral.
